    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_pictures', models.ImageField(blank=True, null=True, upload_to='users/profile-pictures')),
                ('cover_photo', models.ImageField(blank=True, null=True, upload_to='users/cover-photo')),
